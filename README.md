...
I'm sharing the result in case it's useful, but I don't make any promises about its usefulness. Nor about its security: container sandboxing can be escaped, it's a protection against the most obvious mistakes, but not real security to protect your computer and data.
